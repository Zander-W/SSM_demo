...
<head>
    ...
    <link rel="stylesheet" href="/library/css/layuimini.css?v=2.0.4" media="all">
    <link rel="stylesheet" href="/library/css/themes/default.css" media="all">
    <link rel="stylesheet" href="/library/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
...
<script src="/library/js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
